...
const featuredMNCs = [
  ...
  { id: 'mnc-msft', name: 'Microsoft', logo: '/static/images/companies/microsoft.svg', roles: 'University SDE · Azure · AI', title: 'Cloud Solutions & AI Trainee', location: 'Hyderabad, India', salary: '₹15.0 - ₹22.0 LPA', url: 'https://careers.microsoft.com/v2/global/en/home.html#find-jobs?p=India&e=Students%20and%20graduates' },
  { id: 'mnc-infy', name: 'Infosys', logo: '/static/images/companies/infosys.svg', roles: 'Specialist Programmer · DSE', title: 'Specialist Programmer & Systems Engineer', location: 'Bengaluru, India', salary: '₹9.5 - ₹14.0 LPA', url: 'https://career.infosys.com/joblist?countrycode=IN&companyhiringtype=IL' },
  { id: 'mnc-deloitte', name: 'Deloitte', logo: '/static/images/companies/deloitte.svg', roles: 'Tech Analyst · Advisory', title: 'Technology Analyst - Cloud Advisory', location: 'Hyderabad, India', salary: '₹8.5 - ₹13.0 LPA', url: 'https://jobsindia.deloitte.com/search/?q=&locationsearch=India' },
  { id: 'mnc-tm', name: 'Tech Mahindra', logo: '/static/images/companies/techmahindra.svg', roles: 'Associate Software Engineer', title: 'Associate Software Engineer Trainee', location: 'Pune, India', salary: '₹5.5 - ₹8.5 LPA', url: 'https://careers.techmahindra.com/JobSearch.aspx?exp=0-1' },
  ...
  { id: 'mnc-pmi', name: 'PM Internship', logo: '/static/images/companies/pmi.svg', roles: 'Top 500 Corporates Track', title: 'National Corporate Internship (Top 500 Enterprises)', location: 'Pan-India', salary: '₹5,000/mo + ₹6,000 Grant', url: 'https://pminternship.mca.gov.in/candidate-registration/' }
];
...
const featuredPlacements = [
  ...
  { id: 'plc-4', title: 'Technology Analyst - Cloud Advisory', company: 'Deloitte', company_name: 'Deloitte', logo: '/static/images/companies/deloitte.svg', salary: '₹8.5 - ₹13.0 LPA', location: 'Hyderabad', work_mode: 'Hybrid', job_type: 'Full-Time', source: 'Deloitte USI', url: 'https://jobsindia.deloitte.com/search/?q=&locationsearch=India' },
  { id: 'plc-5', title: 'Associate Software Engineer Trainee', company: 'Tech Mahindra', company_name: 'Tech Mahindra', logo: '/static/images/companies/techmahindra.svg', salary: '₹5.5 - ₹8.5 LPA', location: 'Pune', work_mode: 'Onsite', job_type: 'Campus Placement Drive', source: 'Tech Mahindra Campus', url: 'https://careers.techmahindra.com/JobSearch.aspx?exp=0-1' },
...
const featuredInternships = [
  ...
  { id: 'int-4', title: 'Data Analytics & ML Research Intern', company: 'FinEdge Analytics', company_name: 'FinEdge Analytics', logo: null, salary: '₹18,000 - ₹25,000/mo', location: 'Mumbai', work_mode: 'Hybrid', job_type: 'Internship', source: 'FinEdge Hiring', url: 'https://finedge.example.com/careers' }
];
